...
const REVIEW_DESCRIPTION = [
  ...
  "",
  "The user may also answer a question they did not answer before (they walked away or cancelled the quiz) in a LATER message: that message quotes the question's quiz_id and says it is a make-up answer. Grade that one question by its exact quiz_id with this tool — do NOT call ila_quiz again, and do not treat it as a new question.",
  "",
  "Rules:",
  "- verdict is one of: correct, incorrect, unsure. An answer marked unsure (no choice made) is `unsure`, neither right nor wrong.",
  "- Judge only against the question and options the quiz_id names; the quiz panel stores the verdict and shows the explanation under the question.",
...
export const QUIZ_GUIDANCE = [
  ...
  "",
  "Rhythm:",
  "- When the user answers an ila_quiz, judge every question and call ila_review_quiz once with each question's exact quiz_id, verdict (correct / incorrect / unsure) and a short explanation in the user's language; then summarise how they did.",
  "- A later user message that quotes a quiz_id and says it is a make-up answer (补答) — for a question the user skipped or cancelled without answering — is that SAME question being answered late. Grade just that question through ila_review_quiz with the quoted id — never call ila_quiz for it, and never present it as a new question.",
