...
const en: typeof MessageSchema = {
  ...
  chat: {
    ...
    autoBadgeTitle: "Titles are generated by AI from the conversation",
  ...
  sources: {
    ...
    tabFile: "File",
    tabLink: "Web link",
    /* The add dialog's two optional fields — see the Chinese catalog. */
    addTitle: "Title",
    addTitleFileHint: "Left empty, the file's own name is used",
    addTitleLinkHint: "Left empty, the page's own title is used — its URL when it has none",
    addDir: "Folder",
    /* The destination picker — see the Chinese catalog. */
    dirPick: "Choose a folder",
    dirRoot: "Workspace root",
    dirEmpty: "No folders inside this one",
    dirNew: "New folder",
    dirNameHint: "Folder name",
    dirNameInvalid: "A name cannot contain / or \\",
    dirChoose: "Use this folder",
    addFiles: "Files",
