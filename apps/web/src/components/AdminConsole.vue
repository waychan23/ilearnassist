...
import StatsSection from "./admin/StatsSection.vue";
...
<template>
  <div class="console" data-testid="admin-console">
    ...
    <main class="console-main" :inert="isCompact && uiState.drawerOpen">
      ...
      <div v-else-if="section === 'stats'" class="console-body" data-testid="admin-stats-panel">
        <StatsSection />
      </div>
